...
<template>
  ...
  >
    ...
    <nav class="hidden sm:grid grid-flow-col gap-6 items-center font-semibold leading-tight uppercase relative text-gray-500">
      <router-link
        to="/home"
    ...
    <div class="sm:hidden">
      <button @click="mobileMenu = true">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"/></svg>
      </button>

      <div v-show="mobileMenu" class="fixed top-0 bottom-0 left-0 right-0 bg-black">
        <div class="h-screen flex">
          <div class="bg-white">
            <button class="w-14 h-14 flex items-center justify-center text-black" @click="mobileMenu = false">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/></svg>
            </button>
          </div>
          <div class="mt-8 ml-8">
            <ul class="space-y-8 text-2xl text-white">
              <li>
                <router-link
                  to="/home"
                  class="hover:text-dark-blue mix-blend-difference inline-block"
                  :class="{ 'text-dark-blue': $route.name == 'home' }"
                >
                  Home
                </router-link>
              </li>
