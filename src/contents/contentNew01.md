...
> > (ps: 经过实践, 必须了解这些知识点: HTML, CSS 选择器, CSS 基础样式, CSS 伪类, flex 布局与 grid 布局.)

> <span class="line-through">2.将 UI 属性提取出来, 编辑成变量表</span>

> > (ps: 实践中发现并不能完美解决项目中保真率的问题, 于是和前端团队一起使用 TaiwindCSS 将 UI 规范转译成代码 CSS 类 进行管理)
